...
namespace NoteSystem {
    public class WordNote : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if ((Rythm.RythmEngine.Instance.CurrentBeat > this.climaxBeat) & (HitDetection.CheckHit(climaxBeat, Rythm.RythmEngine.Instance.CurrentBeat, this) == HitQuality.Miss)&!hasMissed)
            {
                BroadcastHasMissed();
            }
        }
